...
const Player =
      { ...hasRandom, // <--- new!
      //Reach does not generate random numbers on its own, but rather depends on the user to do it.
        getHand: Fun([], UInt),
...
export const main =
  Reach.App(
    ...
    (A, B) => {
      ...
      checkCommitment(commitA, saltA, handA);//Checks that both hands are committed
