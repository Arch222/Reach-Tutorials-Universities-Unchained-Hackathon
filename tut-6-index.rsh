'reach 0.1';
//Adjust Bob's input to ensure that Alice's inital wager is not lost 
//Also has all the participants do a local step(a localized computation)
...
//Standard Deadline for most blockchain systems based on the Ethereum Blockchain(Number of Blocks)
const DEADLINE = 10;
export const main =
  Reach.App(
    {},
...
//Define wager methods and acceptance
      A.only(() => {
